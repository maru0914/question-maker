...
<template>
    ...
    <AppLayout>
        ...
        <div v-if="$page.props.auth.user" class="flex justify-end mb-4">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-6">
            <Panel
                ...
                :key="book.id"
                class="relative border border-gray-200 rounded-lg hover:scale-105 hover:shadow-xl transition-transform duration-300 ease-in-out"
            >
                ...
                <div class="flex flex-col w-full h-full p-4">
                    ...
                    <h2 class="text-lg text-center mb-2 font-semibold">{{ book.title }}</h2>
